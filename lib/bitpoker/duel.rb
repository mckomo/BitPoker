...
module BitPoker
  ...
  class Duel
    ...
    def initialize(croupier, bot_one, bot_two)
      ...
      raise ArgumentError, 'Proxy one does not implement ProxyInterface.' unless bot_one.is_a?(BitPoker::BotProxyInterface)
      raise ArgumentError, 'Proxy two does not implement ProxyInterface.' unless bot_two.is_a?(BitPoker::BotProxyInterface)
    ...
    def play_round
      ...
      until round.state == Round::STATE_FINISHED
